...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      offer_interactions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "offer_interactions_shop_id_fkey"
            columns: ["shop_id"]
            isOneToOne: false
            referencedRelation: "shops"
            referencedColumns: ["id"]
      ...
      offer_spin_outcomes: {
        ...
        Relationships: [
          {
            foreignKeyName: "offer_spin_outcomes_offer_id_fkey"
            columns: ["offer_id"]
            isOneToOne: false
            referencedRelation: "offers"
            referencedColumns: ["id"]
      ...
      shops: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "shops_node_id_fkey"
            columns: ["node_id"]
            isOneToOne: false
    ...
    Enums: {
      ...
      interaction_type: "scratch" | "spin" | "reveal" | "unlock" | "claim"
      offer_status: "pending" | "approved" | "rejected"
      offer_type: "scratch" | "spin" | "direct"
