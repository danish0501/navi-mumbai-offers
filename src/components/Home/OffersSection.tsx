      ...
      >
        <div className="space-y-4 group">
          ...
          <div className="space-y-2">
            <motion.h2 variants={itemVariants} className="text-4xl md:text-5xl font-display font-bold tracking-tight text-foreground leading-[1.1]">
              Latest <span className="relative inline-block">
                <span className="text-primary italic">Offers</span>
